...
#description     :This file creates a plot: Total number of polygons per month
...
-- Total number of polygons per month
SELECT
	(SELECT 
		coalesce(
			count(id)
...
# Plot-title
plt.title("Development of the Number of Polygons")

# Save plot to *.jpeg-file
plt.savefig('pics/c2_polygons.jpeg')
