...
#description     :This file creates a map: Calculates all invalid polygons
...
SELECT geom
	FROM 
		hist_polygon 
	WHERE 
		(ST_IsValid(geom) = false) AND visible = 'true' AND
...
pic_output_name = 'pics/c6_map_invalid_polygon'
