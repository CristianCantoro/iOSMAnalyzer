...
#description     :This file creates a plot: Calculates the development of the tag-completeness [%] of all "tourism" POIs
...
# Plot-title
plt.title('Development of the Tag-Completeness of all Tourism POIs')

# Save plot to *.jpeg-file
plt.savefig('pics/c5_tag_completeness_tourism.jpeg')
