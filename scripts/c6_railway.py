...
#description     :This file creates a plot: Calculates the development of all objects with a "railway"-tag
...
SELECT
	...
	FROM 
		hist_plp 
	WHERE  tags ? 'railway' AND visible = 'true' AND
...
# Label x and y axis
plt.xlabel('Date')
plt.ylabel('Number of Railway-Objects')

# Plot-title
plt.title("Development of Railway-Objects")

# Save plot to *.jpeg-file
plt.savefig('pics/c6_railway.jpeg')
