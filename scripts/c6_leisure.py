...
#description     :This file creates a plot: Calculates the development of all objects with a "leisure"-tag
...
SELECT
	...
	FROM 
		hist_plp 
	WHERE  tags ? 'leisure' AND visible = 'true' AND
...
# Label x and y axis
plt.xlabel('Date')
plt.ylabel('Number of Leisure-Objects')

# Plot-title
plt.title("Development of Leisure-Objects")

# Save plot to *.jpeg-file
plt.savefig('pics/c6_leisure.jpeg')
