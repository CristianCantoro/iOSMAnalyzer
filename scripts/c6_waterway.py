...
#description     :This file creates a plot: Calculates the development of all objects with a "waterway"-tag
...
SELECT
	...
	FROM 
		hist_plp 
	WHERE  tags ? 'waterway' AND visible = 'true' AND
...
# Label x and y axis
plt.xlabel('Date')
plt.ylabel('Number of Waterway-Objects')

# Plot-title
plt.title("Development of Waterway-Objects")

# show plot
#pylab.show()

# Save plot to *.jpeg-file
plt.savefig('pics/c6_waterway.jpeg')
