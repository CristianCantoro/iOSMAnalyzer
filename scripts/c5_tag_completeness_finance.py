...
#description     :This file creates a plot: Calculates the development of the tag-completeness [%] of all "finance" POIs
...
# Plot-title
plt.title('Development of the Tag-Completeness of all Finance POIs')

# Save plot to *.jpeg-file
plt.savefig('pics/c5_tag_completeness_finance.jpeg')
