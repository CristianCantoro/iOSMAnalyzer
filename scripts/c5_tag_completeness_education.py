...
#description     :This file creates a plot: Calculates the development of the tag-completeness [%] of all "education" POIs
...
# Plot-title
plt.title('Development of the Tag-Completeness of all Education POIs')

# Save plot to *.jpeg-file
plt.savefig('pics/c5_tag_completeness_education.jpeg')
