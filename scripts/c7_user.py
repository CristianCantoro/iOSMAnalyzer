...
#description     :This file creates a plot: Development of contributers with their first contribution per month
...
-- In which year/month did the Users contribute for the first time
SELECT
	(SELECT 
