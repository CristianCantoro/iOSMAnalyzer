...
#description     :This file creates a plot: Calculates the development of all objects with a "amenity"-tag
...
SELECT
	...
	FROM 
		hist_plp 
	WHERE  tags ? 'amenity' AND visible = 'true' AND
...
# Label x and y axis
plt.xlabel('Date')
plt.ylabel('Number of Amenity-Objects')

# Plot-title
plt.title("Development of Amenity-Objects")

# Save plot to *.jpeg-file
plt.savefig('pics/c6_amenity.jpeg')
