...
#description     :This file creates a plot: Calculates the development of all objects with an "natural"-tag
...
SELECT
	...
	FROM 
		hist_plp 
	WHERE  tags ? 'natural' AND visible = 'true' AND
...
# Label x and y axis
plt.xlabel('Date')
plt.ylabel('Number of Natural-Objects')

# Plot-title
plt.title("Development of Natural-Objects")

# Save plot to *.jpeg-file
plt.savefig('pics/c6_natural.jpeg')
